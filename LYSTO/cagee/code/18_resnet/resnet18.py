...
class BasicBlock(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # Adding softmax layer here
        # out = self.softmax(self)
...
if __name__ == '__main__':
    ...
    # Tensor that will be given as input for training is in this format [batch_size, num_channels, shape[0], shape[1]]
